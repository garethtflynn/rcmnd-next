...
const CreatePostModal = ({ isOpen, closeModal, }) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 w-full h-screen text-[#252220] bg-[#000000]">
        <div
          className="bg-[#000000] rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto"
          onClick={(e) => e.stopPropagation()}
        >
          <form
            onSubmit={onSubmit}
            className="flex flex-col bg-opacity-75 items-center justify-center p-4"
          >
            {isImageDropped ? (
              <div
                className="h-80 w-3/4 mx-auto border-dashed border-2 border-[#FBF8F4] flex flex-col jusify-center items-center place-content-center"
                {...getRootProps()}
              >
            ...
            <div className="flex flex-col mx-auto w-10/12 items-center px-5 pt-2">
              <input
                ...
                placeholder="title"
                className="border border-[#FBF8F4] bg-transparent px-2 py-1 my-2 rounded hover:bg-[#4C4138] outline-none placeholder-[#252220] w-full"
              />
              <input
                value={formData.link}
                type="text"
              ...
              <div className="w-full flex justify-end">
                <button
                  onClick={closeModal}
                  type="button"
                  className="w-1/2 text-[#FBF8F4] hover:text-[#14100E]"
                >
                  cancel
                </button>
                <button
