...
const AddPostForm = ({ isOpen, closeModal, listId, listTitle }) => {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="flex flex-col jusify-center place-content-center bg-opacity-75 z-50 items-center justify-center"
    >
      {isImageDropped ? (
        <div
          className="h-64 w-2/4 mx-auto border-dashed border-2 border-[#D7CDBF] flex flex-col jusify-center items-center place-content-center"
          {...getRootProps()}
        >
      ...
      <div className="flex flex-col mx-auto w-10/12 items-center px-5 pt-2">
        <input
          ...
          placeholder="title"
          className="border border-[#FBF8F4] bg-transparent text-[#FBF8F4] px-2 py-1 rounded hover:bg-[#4C4138] outline-none placeholder-[#252220] w-full my-2"
        />
        <input
          value={formData.link}
          type="text"
          ...
          placeholder="link"
          className="border border-[#FBF8F4] bg-transparent text-[#FBF8F4] px-2 py-1 rounded hover:bg-[#4C4138] outline-none placeholder-[#252220] w-full my-1"
        />
        <textarea
